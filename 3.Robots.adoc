...
. Robots may incur damage by falling off the field, making contact with another robot, or contacting field elements. The RoboCupJunior Rescue Committee cannot anticipate all potential situations where damage to the robot may occur. Teams should ensure that all active elements on a robot are adequately protected with resistant materials. For example, teams must protect electrical circuits from all human contact and direct contact with other robots and field elements.
