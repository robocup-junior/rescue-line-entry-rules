...
. Team members may compete in Rescue Line twice (2 international events). After competing in Rescue Line twice, they must move to another RoboCupJunior sub-league.
...
. All teams must complete a web form before the competition to allow referees to prepare better for the interviews. The RoboCupJunior Rescue Committee will provide instructions on submitting the form to the teams at least 4 weeks before the competition.
