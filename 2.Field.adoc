...
image::media/intersections_possibilities_1.png[INTER1,pdfwidth=80%,align=center]
image::media/intersections_possibilities_2.png[INTER2,pdfwidth=90%,align=center]
...
. [Intermediate] After a Lack of Progress (see <<loc>>) , the referee may place the evacuation points in new corners.
...
+
[.text-center]
image::media/beginner_victims.png[BEGGINER_VICTIMS,pdfwidth=50%,align=center]
