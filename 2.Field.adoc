...
[.text-center]
image::media/beginner_victims.png[BEGGINER_VICTIMS,width=500,pdfwidth=50%,align=center]
+
. 【Intermediate】 
...
image::media/evac_zone.png[EVAC-ZONES,width=700,pdfwidth=70%,align=center]
