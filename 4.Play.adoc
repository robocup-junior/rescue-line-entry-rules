...
+
A rescue shall be considered successful when the robot places the victim at the evacuation point and the victim (can) remains standing independently for 5 seconds after the robot has completely moved away.
