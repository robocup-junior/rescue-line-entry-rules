...
+
image::media/victim_placement.png[VICTIM_PLACEMENT,pdfwidth=85%,align=center]
...
Each successful rescue shall be worth 10 points.
+
image::media/evac_point_placement.png[EVAC_POINT_PLACEMENT,pdfwidth=85%,align=center]
