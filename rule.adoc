...
An autonomous robot should follow a black line while overcoming problems in a modular field formed by tiles with different patterns. The floor is white, and the tiles are on diffrent levels connected with ramps.
...
The robot earns points as follows:
